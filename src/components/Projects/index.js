    ...
    <Container id="projects">
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          <Divider />
          {toggle === 'design' ?
            <ToggleButton active value="design" onClick={() => setToggle('design')}>UI/UX Design</ToggleButton>
            :
            <ToggleButton value="design" onClick={() => setToggle('design')}>UI/UX Design</ToggleButton>
          }
          <Divider />
          {toggle === 'blockchain' ?
